"""鲁棒性: down-sampling ARI. Cool-warm palette."""
...
COLORS={"baron":COOL,"GSE103322":NEUTRAL,"GSE119531":WARM}
MARKERS={"baron":"o","GSE103322":"s","GSE119531":"D"}

apply_nature_style()
plt.rcParams.update({"font.family":"sans-serif","font.sans-serif":["Arial","Helvetica","DejaVu Sans"],
    "font.size":9,"axes.spines.top":False,"axes.spines.right":False,"axes.linewidth":0.6,"pdf.fonttype":42})
...
ax.set_xlabel("Down-sampling ratio",fontsize=10); ax.set_ylabel("ARI",fontsize=10)
ax.set_xticks([0.1,0.3,0.5,0.7,0.9,1.0]); ax.set_xlim(0.05,1.05); ax.set_ylim(0.3,1.0)
ax.legend(frameon=False,fontsize=8,loc="lower right"); ax.tick_params(length=3,width=0.6)
ax.axhline(y=0.5,color="#ddd",linewidth=0.5,linestyle="--",zorder=1)
plt.tight_layout()
for ext in ["pdf","svg","png"]: fig.savefig(f"{OUT}/Figure7.{ext}",dpi=300,bbox_inches="tight")
print(f"done -> {OUT}")
