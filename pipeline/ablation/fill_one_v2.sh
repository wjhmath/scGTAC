#!/bin/bash
#SBATCH --job-name=abl_v2
#SBATCH --output=/home/liyang/BioJiaheWang/scGTAC/log/abl_v2_%j.out
#SBATCH --error=/home/liyang/BioJiaheWang/scGTAC/log/abl_v2_%j.err
#SBATCH --nodes=1
#SBATCH -n 1
...
NAME="$1"; DATA="$2"; NCLUST="${3:-auto}"; EP="${4:-200}"; CK=/tmp/fillv2_${SLURM_JOB_ID:-$$}.pt
